...
_PAGE_BOTTOM_VIDEO_CSS = (
    ...
    '   5 (user reference, where cover=1). Web-only; print hides them.\n'
    '   Absolutely-positioned within .page (which is position:relative).\n'
    '   width: calc(100% - 10mm) explicitly sizes the video to (page_width\n'
    '   - 5mm left margin - 5mm right margin); we cannot rely on the\n'
    '   left/right shorthand because <video> is a replaced element and\n'
    '   width:auto falls back to the video\\\'s intrinsic pixel width.\n'
    '   height: auto preserves the natural aspect ratio of each clip. */\n'
    '.page-bottom-video {\n'
    '  position: absolute;\n'
    '  bottom: 5mm;\n'
    '  left: 5mm;\n'
